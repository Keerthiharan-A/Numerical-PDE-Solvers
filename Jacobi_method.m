...
% Absolute error Norm: 0.349823, error between successive iteration is 9.984976322291160e-09
% Plot the surface of the numerical solution
figure;
surf((0:N)*del, (0:N)*del, u);
title('Surface Plot of Numerical Solution using Jacobi method (u)');
xlabel('X');
ylabel('Y');
zlabel('Temperature');
xlim([0, L]);
